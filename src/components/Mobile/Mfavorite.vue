...
<template>
            ...
            <div class="modal">
                ...
                <div class="product_info">
                    <img :src="currentProduct?.file_path" alt="product image"
                        style="width: 280px;height:280px;object-fit: contain; /* 關鍵設定：保持圖片比例 */" />
                </div>
    ...
    <div v-if="favoriteList.length === 0" class="fav-empty">
        目前收藏清單是空的
    </div>
    <div class="fav-container" :class="$attrs.class">
